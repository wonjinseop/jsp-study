...
import com.jsp.chap04.service.DeleteServise;
import com.jsp.chap04.service.IDancerService;
import com.jsp.chap04.service.ListServise;
...
// 응답할 view를 결정합니다
@WebServlet("*.do") // 확장자 패턴 -> 앞이 뭐든간에 .do로 끝나는 요쳥이라면 이 서블릿이 다 받겠다.
